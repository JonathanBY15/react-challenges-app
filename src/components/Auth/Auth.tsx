...
const Auth = () => {
  ...
  return (
    <div className="auth-container bg-[#282828]">
      <GradientBlob size={250} top="30%" left="40%" opacity={0.6} animationDelay="2s" colors={["#00bcd4", "#3498db", "#2c3e50"]} />
      ...
      <GradientBlob size={250} top="75%" left="50%" opacity={0.6} animationDelay="0.8s" colors={["#6a0dad", "#8e44ad", "#2c3e50"]} />
